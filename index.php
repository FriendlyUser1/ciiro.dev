		...
		<div class="row h-100 align-items-center">
			<div class="col">
				...
				<main class="lead">
					<p class="fs-5">
						<a
							class="discrete-link pe-2"
							href="https://github.com/FriendlyUser1"
							target="_blank"
							data-bs-toggle="tooltip"
							aria-label="GitHub"
							data-bs-original-title="GitHub"><i class="fa-brands fa-github"></i></a>
						<a
							class="discrete-link pe-2"
							href="https://bsky.app/profile/ciiro.dev"
							target="_blank"
							data-bs-toggle="tooltip"
							aria-label="Bluesky"
							data-bs-original-title="Bluesky"><i class="fa-brands fa-bluesky"></i>
						</a>
					</p>
					<div class="content-separator"></div>
					<p class="fs-5">
				...
				<footer class="py-3">
					<div class="pt-3">
						by Felix at <a href="https://ciiro.dev">ciiro.dev</a>
					</div>
				</footer>
			</div>
		</div>
